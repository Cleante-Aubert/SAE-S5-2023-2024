...
CREATE TABLE Film (
    FilmID INT NOT NULL AUTO_INCREMENT PRIMARY KEY , Titre VARCHAR(255),
    DateSortie DATE, DureeFilm TIME,
...
CREATE TABLE Utilisateur (
    UtilisateurID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, NomUtilisateur VARCHAR(255),
    PrenomUtilisateur VARCHAR(255), PseudoUtilisateur VARCHAR(50),
    Email VARCHAR(255), MotDePasse VARCHAR(255), DateInscription DATE
);
CREATE TABLE Acteur (
     ActeurID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, NomActeur VARCHAR(50),
     PrenomActeur VARCHAR(50), DateNaissanceActeur DATE, BiographieActeur TEXT
);
...
CREATE TABLE Critiques (
     ...
     UtilisateurID INT, FilmID INT, Note INT,
