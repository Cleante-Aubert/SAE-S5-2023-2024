...
<section class="profile-info-card">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4 py-4">
            <p><?= e($_SESSION["NomUtilisateur"]) ?> <?= e($_SESSION["PrenomUtilisateur"]) ?></p>
            <p><?= e($_SESSION["PseudoUtilisateur"]) ?></p>
            <p><?= e($_SESSION["Email"]) ?></p>
            <p>Inscrit depuis le : <?= e($_SESSION["DateInscription"]) ?></p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="d-flex justify-content-end p-2">
                <a href="?controller=profil&action=modifier">
                    <button type="button" class="btn btn-md p_btn">Modifier mes informations</button>
                </a>
            </div>
        </div>
        <div class="col-md-4 mb-4"></div>
